...
/home/sophiepq/bin/NGSadmix -likes ~/Chapter3/ANGSD/beagle_autosomes/angsd_autosomes_wolvesdogsothercanids_output.beagle.gz -K 8 -o ~/Chapter3/NGSadmix/results/NGSadmix_allchr_allcanids_K8  -P 10
