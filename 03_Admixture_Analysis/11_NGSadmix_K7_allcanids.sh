...
/home/sophiepq/bin/NGSadmix -likes ~/Chapter3/ANGSD/beagle_autosomes/angsd_autosomes_wolvesdogsothercanids_output.beagle.gz -K 7 -o ~/Chapter3/NGSadmix/results/NGSadmix_allchr_allcanids_K7 -P 10
